...
leftarm = pygame.image.load(r"lab7\images\leftarm.png")
rightarm = pygame.image.load(r"lab7\images\rightarm.png")
mainclock = pygame.transform.scale(pygame.image.load(r"lab7\images\clock.png"), (800, 600))
